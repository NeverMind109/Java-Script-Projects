...
const typingTextEl = document.querySelector(".game__descr");
const inputField = document.querySelector(".game__input");
const timeTag = document.getElementById("time-counter");
const mistakesTag = document.getElementById("mistakes-counter");
const wpmTag = document.getElementById("wpm-counter");
const cpmTag = document.getElementById("cpm-counter");
const tryAgainBtn = document.querySelector(".game__btn");
...
function randomParagraph() {
  ...
  typingTextEl.addEventListener("click", () => inputField.focus());
}
...
function initTyping() {
  ...
  if (charIndex < characters.length - 1 && timeLeft > 0) {
    ...
    //   if wpm value is 0, empty or infinity then set it to 0
